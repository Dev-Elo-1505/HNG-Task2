  ...
  return (
    <>
      ...
      <section className="py-[7.5rem] px-6 flex flex-col gap-6 justify-between md:px-[7.5rem] md:py-20">
        ...
        <div className="flex items-end h-96"><button className="w-full py-5 px-6 bg-[#151515] rounded-lg text-[#fefefe] font-medium hover:opacity-90 active:scale-95 transition ease-in-out delay-150">Back To Shop</button></div>
      </section>
    </>
  );
};
